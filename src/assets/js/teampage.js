    ...
    for(let i=0;i<data.length;i++)
    {
        ...
        if(next_item.Key == teamKey)
        {
            ...
            `
                ...
                <div id="test1" style="background-color:#${next_item.PrimaryColor}"> Primary </div></br>
                <div id="test2" style="background-color:#${next_item.SecondaryColor}"> Secondary </div></br>
                <div id="test3" style="background-color:#${next_item.TertiaryColor}"> Tertiary </div></br>
                ...
                <div>Stadium Name: ${next_item.StadiumDetails.Name}</div>
                <div>City: ${next_item.StadiumDetails.City}</div>
                <div>State: ${next_item.StadiumDetails.State}</div>
            `;
            html += `
                <br />
            `;
...
const generateHtml_TeamStandings = (data) => 
{
    ...
    for(let i=0;i<data.length;i++)
    {
        ...
        if(next_item.Team == teamKey)
        {
            let html = 
            `
                <div>Wins: ${next_item.Wins}</div>
                <div>Losses: ${next_item.Losses}</div>
                <div>Ties: ${next_item.Ties}</div>
                <div>Percentage: ${next_item.Percentage}</div>
                <div>Points For: ${next_item.PointsFor}</div>
                <div>Points Against: ${next_item.PointsAgainst}</div>
                <div>Net Points: ${next_item.NetPoints}</div>
                <div>Touchdowns: ${next_item.Touchdowns}</div>
            `;
            html += `
                <br />
            `;
